...
function UserMenu({ userChanged, setUserChanged }) {
  ...
  <div className={`dropdown ${open ? 'show' : 'hide'}`}>
    ...
    <div className="dropdown-item">
      ...
      <Link to="/MyEvent" onClick={() => setOpen(false)} style={{ flex: 1, textDecoration: 'none', color: '#333' }}>
        My Event
      </Link>
    </div>
...
export default function App() {
  ...
  return (
    <div>
      ...
      {!hideNavbar && (
        <nav className='navbar'>
          <div className='navbar-logo'>
            <Link to="/">
              <img src={img1} alt="Logo" style={{ height: '60px', width: '80px'}} />
            </Link>
          </div>
      ...
      <main style={{
        paddingTop: hideNavbar ? '0px' : '80px',
        paddingLeft: '16px',
        paddingRight: '16px',
        paddingBottom: '16px'
      }}>
